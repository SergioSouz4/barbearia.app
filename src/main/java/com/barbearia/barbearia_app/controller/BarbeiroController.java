...
public class BarbeiroController {
    ...
    @PostMapping
    public ResponseEntity<Barbeiro> criar(@Valid @RequestBody BarbeiroRequestDTO barbeiroDTO) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Barbeiro> atualizar(@PathVariable Long id, @Valid @RequestBody BarbeiroRequestDTO barbeiroDTO) {
