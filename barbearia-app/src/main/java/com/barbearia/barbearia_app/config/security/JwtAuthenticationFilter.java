        ...
        try {
            ...
            if (StringUtils.hasText(jwt) && tokenProvider.validateToken(jwt)) {
                ...
                if ("admin".equals(tokenType)) {
                    // Para administradores, usar o UserDetailsService normal
                    userDetails = userDetailsService.loadUserByUsername(username);
                } else {
                    // Para clientes, criar UserDetails simples
                    userDetails = User.builder()
                            .username(username)
                            .password("") // Não há senha para clientes
                            .authorities(tokenProvider.getAuthorities(jwt))
                            .build();
                }
